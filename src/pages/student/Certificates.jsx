            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleDownload(cert._id, cert.eventId?.title || 'certificate')}
                    disabled={downloading[cert._id]}
                    className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg text-xs font-semibold hover:from-amber-600 hover:to-orange-600 active:scale-[0.97] transition-all shadow-sm disabled:opacity-60"
                  >
